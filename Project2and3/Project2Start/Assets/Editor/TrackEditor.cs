...
public class TrackEditor : Editor
{
    ...
    private SerializedProperty changeStartDirection;
    ...
    private void OnEnable()
    {
        ...
        changeStartDirection = this.serializedObject.FindProperty("moveTowardsFirstPoint");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_myTarget.moveTowardsFirstPoint)
        {
            ...
            _myTarget.secondTrackArrow.SetActive(false);
        }
        else
        {
            _myTarget.firstTrackArrow.SetActive(false);
            _myTarget.secondTrackArrow.SetActive(true);
        }
